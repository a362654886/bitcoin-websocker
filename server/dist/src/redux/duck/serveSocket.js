...
exports.serveSockets = exports.DELETE_SOCKET = exports.ADD_SOCKET = void 0;
...
const serveSockets = (state = new Map(), action) => createReducer_1.createReducer(state, action, handlers);
exports.serveSockets = serveSockets;
